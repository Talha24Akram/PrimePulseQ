...
import { ArrowRight, Shield, Zap, BarChart3, CheckCircle2, MessageSquare, Users, TrendingUp, Lock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="pt-24 pb-20 px-6">
        ...
        {/* Hero visual — intentionally kept dark to simulate the app UI */}
        <div className="mx-auto max-w-5xl mt-20">
          <div className="rounded-2xl border border-gray-200 dark:border-white/8 bg-gray-200/50 dark:bg-gray-900/50 p-2 shadow-2xl shadow-gray-300/60 dark:shadow-black/40">
            <div className="rounded-xl bg-gray-900 overflow-hidden">
              <div className="bg-gray-950 px-4 py-3 flex items-center gap-2">
                ...
                <div className="flex-1 mx-4 h-6 rounded bg-gray-800 flex items-center px-3">
                  <span className="text-gray-500 text-xs">app.primepulseq.com/dashboard</span>
                </div>
              </div>
              <div className="p-8 bg-gray-900">
                <div className="grid grid-cols-4 gap-4 mb-6">
                  {[
                    { label: "Engagement Score", value: "82%", color: "text-emerald-400", bg: "bg-emerald-500/10 border-emerald-500/20" },
                    { label: "Response Rate", value: "74%", color: "text-violet-400", bg: "bg-violet-500/10 border-violet-500/20" },
                    { label: "Active Surveys", value: "3", color: "text-blue-400", bg: "bg-blue-500/10 border-blue-500/20" },
                ...
                <div className="bg-gray-800/50 rounded-xl p-5 border border-white/8">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-100">Weekly Engagement Trend</h3>
                    <span className="text-xs text-emerald-400 font-medium bg-emerald-500/10 border border-emerald-500/20 px-2 py-1 rounded-full">↑ +6% this month</span>
                  </div>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="p-6 rounded-xl border border-gray-200 dark:border-white/8 bg-white dark:bg-white/5 text-left">
      ...
      {/* Features */}
      <section id="features" className="py-24 px-6 bg-gray-100 dark:bg-white/3">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Everything you need. Nothing you don&apos;t.</h2>
            <p className="text-lg text-gray-500 dark:text-gray-400">Built for teams that want signal, not noise.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: <Lock className="h-5 w-5 text-violet-500 dark:text-violet-400" />,
              ...
              {
                icon: <BarChart3 className="h-5 w-5 text-violet-500 dark:text-violet-400" />,
              ...
              {
                icon: <Users className="h-5 w-5 text-violet-500 dark:text-violet-400" />,
                title: "Team segmentation",
                desc: "Understand differences across departments, roles, and tenure without exposing identities.",
              },
              {
                icon: <Shield className="h-5 w-5 text-violet-500 dark:text-violet-400" />,
                title: "Slack & Teams ready",
                desc: "Send surveys directly in Slack or Microsoft Teams. Meet employees where they work.",
              },
            ].map((feature) => (
              <div key={feature.title} className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-white/8">
      ...
      <section id="how-it-works" className="py-24 px-6">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Up and running in minutes</h2>
            <p className="text-lg text-gray-500 dark:text-gray-400">No lengthy onboarding. No dedicated HR consultant needed.</p>
          </div>
          <div className="space-y-12">
            {[
              ...
              <div key={item.step} className="flex gap-8 items-start">
                <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-violet-600 flex items-center justify-center shadow-lg shadow-violet-500/30 dark:shadow-violet-900/40">
      ...
      <section className="py-24 px-6 bg-gray-100 dark:bg-white/3">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Simple, honest pricing</h2>
          <p className="text-lg text-gray-500 dark:text-gray-400 mb-10">No per-seat gotchas. No feature gates that kill momentum.</p>
          <div className="grid md:grid-cols-3 gap-6 text-left">
            {[
              ...
              <div key={tier.name} className={`p-6 rounded-xl border ${tier.highlight ? "border-violet-500 bg-violet-600 shadow-xl shadow-violet-500/30 dark:shadow-violet-900/40" : "border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900"}`}>
                <p className={`text-sm font-medium mb-1 ${tier.highlight ? "text-violet-200" : "text-gray-500 dark:text-gray-400"}`}>{tier.name}</p>
                <div className="flex items-end gap-1 mb-1">
                  <span className={`text-4xl font-bold ${tier.highlight ? "text-white" : "text-gray-900 dark:text-white"}`}>{tier.price}</span>
      ...
      <section className="py-24 px-6 bg-violet-600">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-violet-200 text-lg mb-10">Try Growth free for one week. Cancel anytime.</p>
          <Link href="/signup">
