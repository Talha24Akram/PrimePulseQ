...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-white data-[state=active]:text-violet-700 data-[state=active]:border data-[state=active]:border-violet-200 data-[state=active]:shadow-sm",
      "dark:text-gray-400 dark:hover:text-gray-200",
      "dark:data-[state=active]:bg-violet-600/20 dark:data-[state=active]:text-violet-300 dark:data-[state=active]:border-violet-500/30",
      className
    )}
    {...props}
  />
