...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#080b12] disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:translate-y-px",
  {
    variants: {
      variant: {
        default:
          "bg-violet-600 text-white shadow-sm shadow-violet-900/20 hover:bg-violet-500",
        destructive:
